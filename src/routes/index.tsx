...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "DRAGO — ремонт и перетяжка кресел в Минске | drago.by" },
      { name: "description", content: "Ремонт и перетяжка офисных и компьютерных кресел в Минске с 2013 года. 100+ перетянутых, 200+ отремонтированных. Гарантия, выезд, честные цены." },
      { property: "og:title", content: "DRAGO — ремонт и перетяжка кресел в Минске" },
      { property: "og:description", content: "Возвращаем креслам вторую жизнь. Гарантия 12 месяцев, бесплатная диагностика." },
