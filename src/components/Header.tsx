      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <a
            ...
            aria-label="Позвонить +375 29 382-12-58"
          >
            <Phone className="w-4 h-4 text-accent" aria-hidden="true" />
<span class="hidden lg:inline">+375&nbsp;29&nbsp;382-12-58</span>
            <span className="lg:hidden">Звонок</span>
          </a>
          <div className="hidden md:flex items-center gap-1">
            <a href="https://wa.me/375293821258" target="_blank" rel="noreferrer" aria-label="WhatsApp" className="w-9 h-9 flex items-center justify-center border border-border hover:border-accent hover:text-accent transition-colors">
            ...
            <a href="https://t.me/drago_minsk" target="_blank" rel="noreferrer" aria-label="Telegram" className="w-9 h-9 flex items-center justify-center border border-border hover:border-accent hover:text-accent transition-colors">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="#0088cc"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.14.18-.357.295-.6.295-.002 0-.003 0-.005 0l.213-3.054 5.56-5.022c.24-.213-.054-.334-.373-.121l-6.869 4.326-2.96-.924c-.64-.2-.652-.64.134-.954l11.566-4.458c.538-.196 1.006.128.832.938z"/></svg>
            </a>
          </div>
          <a
            href="/kontakty#form"
